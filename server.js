...
const get_groups = (data) => {
    ...
    const business_detail = {
        ...
        business_detail_pet_file: data.business_detail_pet_file,
        business_detail_pet_type1_amount: data.business_detail_pet_type1_amount,
        business_detail_pet_type1_selected: data.business_detail_pet_type1_selected,
        business_detail_pet_type2_amount: data.business_detail_pet_type2_amount,
        business_detail_pet_type2_selected: data.business_detail_pet_type2_selected,
        business_detail_pet_type3_amount: data.business_detail_pet_type3_amount,
        business_detail_pet_type3_selected: data.business_detail_pet_type3_selected,
        business_detail_pet_type4_amount: data.business_detail_pet_type4_amount,
        business_detail_pet_type4_selected: data.business_detail_pet_type4_selected,
        business_detail_pet_type5_amount: data.business_detail_pet_type5_amount,
        business_detail_pet_type5_selected: data.business_detail_pet_type5_selected,
        business_detail_pet_type6_amount: data.business_detail_pet_type6_amount,
        business_detail_pet_type6_selected: data.business_detail_pet_type6_selected,
